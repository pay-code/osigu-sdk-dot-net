...
namespace OsiguSDK.SpecificationTests.Claims.Providers
{
    ...
    [NUnit.Framework.DescriptionAttribute("Get a List of Claims")]
    public partial class GetAListOfClaimsFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Get a List of Claims", "\tIn order to get a list of a claims\r\n\tAs Provider\r\n\tI want to be able to get ever" +
                    "y claim", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line 9
 testRunner.When("I request the get a list of claims endpoint", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 10
...
#line 21
 testRunner.And("the list should have the same amount of claims as expected", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            this.ScenarioCleanup();
        }
    }
