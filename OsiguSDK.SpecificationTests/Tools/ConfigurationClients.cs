...
namespace OsiguSDK.SpecificationTests.Tools
{
    ...
    {
        public static IConfiguration ConfigInsurer1 => _configInsurer1 ??
        ...
        public static IConfiguration ConfigInsurer2 => _configInsurer2 ??
        ...
        public static IConfiguration ConfigProviderBranch1 => _configProviderBranch1 ??
        ...
        public static IConfiguration ConfigProviderBranch2 => _configProviderBranch2 ??
        ...
        public static IConfiguration ConfigSettlement => _configSettlement ??
        ...
        private static IConfiguration _configInternal;

        public static IConfiguration ConfigInternal => _configInternal ??
                                                       (_configInternal =
                                                           ConfigurationManager.AppSettings["TestingEnvironment"] == "DEV"
                                                               ? new Configuration
                                                               {
                                                                   BaseUrl = ConfigurationManager.AppSettings["InternalDevBaseUrl"],
                                                                   Slug = ConfigurationManager.AppSettings["InternalDevSlug"],
                                                                   Authentication = new Authentication(ConfigurationManager.AppSettings["InternalDevToken"])
                                                               }
                                                               : ConfigurationManager.AppSettings["TestingEnvironment"] == "PROD"
                                                                   ? new Configuration
                                                                   {
                                                                       BaseUrl = ConfigurationManager.AppSettings["InternalProdBaseUrl"],
                                                                       Slug = ConfigurationManager.AppSettings["InternalProdSlug"],
                                                                       Authentication = new Authentication(ConfigurationManager.AppSettings["InternalProdToken"])
                                                                   }
                                                                   : new Configuration
                                                                   {
                                                                       BaseUrl = ConfigurationManager.AppSettings["InternalSboxBaseUrl"],
                                                                       Slug = ConfigurationManager.AppSettings["InternalSboxSlug"],
                                                                       Authentication = new Authentication(ConfigurationManager.AppSettings["InternalSboxToken"])
                                                                   });
