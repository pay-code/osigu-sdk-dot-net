...
namespace OsiguSDK.SpecificationTests.Products
{
    ...
    [NUnit.Framework.DescriptionAttribute("Get a list of product by an Insurer")]
    public partial class GetAListOfProductByAnInsurerFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Get a list of product by an Insurer", "\tIn order to get a list of all products \r\n\tAs an Insurer\r\n\tI want to send an auth" +
                    "orized request to get them", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line 7
 testRunner.Given("I have the insurer products client whit an invalid token", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 8
...
#line 18
 testRunner.When("I make the get list of products request to the endpoint", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 19
 testRunner.Then("the results should be list of products", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
    }
