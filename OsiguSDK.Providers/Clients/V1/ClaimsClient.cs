...
namespace OsiguSDK.Providers.Clients.v1
{
    public class ClaimsClient : BaseClient
    {
        ...
        {
            var urlBuilder = new StringBuilder("/v1/providers/").Append(Configuration.Slug).Append("/authorizations/").Append(authorizationId).Append("/claims");
        ...
        {
            var urlBuilder = new StringBuilder("/v1/providers/").Append(Configuration.Slug).Append("/claims/").Append(claimId).Append("/complete");
            var requestData = new RequestData(urlBuilder.ToString(), Method.POST, null, request);
        ...
        {
            var urlBuilder = new StringBuilder("/v1/providers/").Append(Configuration.Slug).Append("/claims").Append("?page=").Append(page).Append("&size=").Append(size);
            var requestData = new RequestData(urlBuilder.ToString(), Method.GET, null, null);
