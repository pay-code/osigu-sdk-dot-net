...
namespace OsiguSDK.Providers.Clients
{
    public class ProductsClient : BaseClient
    {
        ...
        {
            var urlBuilder = new StringBuilder("/providers/").Append(Configuration.Slug).Append("/products");
        ...
        {
            var urlBuilder = new StringBuilder("/providers/").Append(Configuration.Slug).Append("/products/").Append(productId);
