...
namespace OsiguSDK.Insurers.Clients.V2
{
    public class ExpressAuthorizationClient : BaseClient
    {
        ...
        {
            var urlBuilder = new StringBuilder("/v2/insurers/").Append(Configuration.Slug).Append("/authorizations/express/").Append(id);
        ...
        {
            var urlBuilder = new StringBuilder("/v2/insurers/").Append(Configuration.Slug).Append("/authorizations/express").Append("?status=").Append(status.ToString().ToLower()).Append("&page=").Append(page).Append("&size=").Append(size); ;
            var requestData = new RequestData(urlBuilder.ToString(), Method.GET, null, null);
        ...
        {
            var urlBuilder = new StringBuilder("/v2/insurers/").Append(Configuration.Slug).Append("/authorizations/express/").Append(id).Append("/review");
        ...
        {
            var urlBuilder = new StringBuilder("/v2/insurers/").Append(Configuration.Slug).Append("/authorizations/express/").Append(id).Append("/approve");
        ...
        {
            var urlBuilder = new StringBuilder("/v2/insurers/").Append(Configuration.Slug).Append("/authorizations/express/").Append(id).Append("/reject");
        ...
        {
            var urlBuilder = new StringBuilder("/v2/insurers/").Append(Configuration.Slug).Append("/authorizations/express/").Append(id).Append("/pay");
            var requestData = new RequestData(urlBuilder.ToString(), Method.POST, null, null);
            ExecuteMethod(requestData);
        }
