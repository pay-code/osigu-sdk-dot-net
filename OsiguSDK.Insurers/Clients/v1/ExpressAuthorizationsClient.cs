...
{
    public class ExpressAuthorizationsClient : BaseClient
    {
        ...
        public ExpressAuthorizationsClient(IConfiguration configuration) : base(configuration)
        {
        }

        public ExpressAuthorization GetSingle(string id)
        {
        ...
        public Pagination<ExpressAuthorization> GetList(ExpressAuthorizationStatus? status = ExpressAuthorizationStatus.INSURER_PENDING_REVIEW,  int? page = 0, int? size = 25)
        {
